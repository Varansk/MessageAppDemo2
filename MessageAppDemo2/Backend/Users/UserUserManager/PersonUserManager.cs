...
namespace MessageAppDemo2.Backend.Users.UserUserManager
{
    public class PersonUserManager : IUserUserManager<Person>
    {
        ...
        public bool AddFriend(Person User1, User User2)
        {
        ...
        public bool BlockUser(Person Blocker, User Blocked)
        {
            DatabaseRepository<User, Guid> userRepository = DatabaseUserRepositoryPools.GetDatabaseUserRepositoryPool("DTBR").Get();
        ...
        public bool RemoveFriend(Person User1, User User2)
        {
            DatabaseRepository<User, Guid> userRepository = DatabaseUserRepositoryPools.GetDatabaseUserRepositoryPool("DTBR").Get();
        ...
        public bool UnBlockUser(Person Blocker, User Blocked)
        {
            DatabaseRepository<User, Guid> userRepository = DatabaseUserRepositoryPools.GetDatabaseUserRepositoryPool("DTBR").Get();
